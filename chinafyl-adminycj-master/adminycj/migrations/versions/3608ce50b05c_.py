...
Revision ID: 3608ce50b05c
Revises: a2241b7147ac
Create Date: 2020-06-04 08:24:06.988850
...
revision = '3608ce50b05c'
down_revision = 'a2241b7147ac'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_index('ix_audit_inspector_id', table_name='audit')
...
def downgrade():
    ...
    op.create_index('ix_audit_inspector_id', 'audit', ['inspector_id'], unique=False)
    # ### end Alembic commands ###
