...
class Classification(LossFunction):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7480>'
...
class Regression(LossFunction):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f4d6e450>'
...
class EpsilonInsensitive(Regression):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d79f0>'
...
class Hinge(Classification):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7960>'
...
class Huber(Regression):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d79c0>'
...
class Log(Classification):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7600>'
...
class ModifiedHuber(Classification):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7930>'
...
class SquaredEpsilonInsensitive(Regression):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7a20>'
...
class SquaredHinge(Classification):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7990>'
...
class SquaredLoss(Regression):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f25f43d7900>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25f440d3c8>'

__spec__ = None # (!) real value is "ModuleSpec(name='sklearn.linear_model._sgd_fast', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25f440d3c8>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/sklearn/linear_model/_sgd_fast.cpython-35m-x86_64-linux-gnu.so')"
