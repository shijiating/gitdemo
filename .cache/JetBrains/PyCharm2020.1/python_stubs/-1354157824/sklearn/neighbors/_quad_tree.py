# encoding: utf-8
# module sklearn.neighbors._quad_tree
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25f5b510f0>'

__pyx_capi__ = {
    'EPSILON': None, # (!) real value is '<capsule object "float" at 0x7f260e159f00>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='sklearn.neighbors._quad_tree', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25f5b510f0>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/sklearn/neighbors/_quad_tree.cpython-35m-x86_64-linux-gnu.so')"
