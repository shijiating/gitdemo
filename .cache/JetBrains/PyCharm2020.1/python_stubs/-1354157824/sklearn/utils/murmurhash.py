...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26000919e8>'

__pyx_capi__ = {
    'murmurhash3_bytes_s32': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int32_t (PyObject *, unsigned int, int __pyx_skip_dispatch)" at 0x7f2600086db0>'
    'murmurhash3_bytes_u32': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint32_t (PyObject *, unsigned int, int __pyx_skip_dispatch)" at 0x7f2600086330>'
    'murmurhash3_int_s32': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int32_t (int, unsigned int, int __pyx_skip_dispatch)" at 0x7f25fff5ab40>'
    'murmurhash3_int_u32': None, # (!) real value is '<capsule object "__pyx_t_5numpy_uint32_t (int, unsigned int, int __pyx_skip_dispatch)" at 0x7f25fff5aab0>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='sklearn.utils.murmurhash', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26000919e8>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/sklearn/utils/murmurhash.cpython-35m-x86_64-linux-gnu.so')"
