...
class SplitInfo(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__dict__': <attribute '__dict__' of 'SplitInfo' objects>, '__weakref__': <attribute '__weakref__' of 'SplitInfo' objects>, '__module__': 'sklearn.ensemble._hist_gradient_boosting.splitting', '__init__': <cyfunction SplitInfo.__init__ at 0x7f25f1a14830>, '__doc__': 'Pure data class to store information about a potential split.\\n\\n    Parameters\\n    ----------\\n    gain : float\\n        The gain of the split.\\n    feature_idx : int\\n        The index of the feature to be split.\\n    bin_idx : int\\n        The index of the bin on which the split is made.\\n    missing_go_to_left : bool\\n        Whether missing values should go to the left child.\\n    sum_gradient_left : float\\n        The sum of the gradients of all the samples in the left child.\\n    sum_hessian_left : float\\n        The sum of the hessians of all the samples in the left child.\\n    sum_gradient_right : float\\n        The sum of the gradients of all the samples in the right child.\\n    sum_hessian_right : float\\n        The sum of the hessians of all the samples in the right child.\\n    n_samples_left : int, default=0\\n        The number of samples in the left child.\\n    n_samples_right : int\\n        The number of samples in the right child.\\n    '})"
...
class Splitter(object):
    ...
    has_missing_values = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    missing_values_bin_idx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    n_bins_non_missing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25f1796a90>'

__spec__ = None # (!) real value is "ModuleSpec(name='sklearn.ensemble._hist_gradient_boosting.splitting', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f25f1796a90>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/sklearn/ensemble/_hist_gradient_boosting/splitting.cpython-35m-x86_64-linux-gnu.so')"
