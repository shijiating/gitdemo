...
class MT19937(__numpy_random__bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f11a62247b0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f11a51ec1d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._mt19937', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f11a51ec1d0>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/numpy/random/_mt19937.cpython-35m-x86_64-linux-gnu.so')"
