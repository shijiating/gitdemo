...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26007425c0>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.signal.sigtools', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26007425c0>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/scipy/signal/sigtools.cpython-35m-x86_64-linux-gnu.so')"
