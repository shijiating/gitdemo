...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006a87b8>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.sparse.linalg.isolve._iterative', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006a87b8>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/scipy/sparse/linalg/isolve/_iterative.cpython-35m-x86_64-linux-gnu.so')"
