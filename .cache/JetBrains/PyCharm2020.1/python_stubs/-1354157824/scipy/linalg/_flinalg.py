...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006330b8>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.linalg._flinalg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006330b8>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/scipy/linalg/_flinalg.cpython-35m-x86_64-linux-gnu.so')"
