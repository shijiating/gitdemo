...
class ExtType(__pandas_io_msgpack.ExtType):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas.io.msgpack', '__dict__': <attribute '__dict__' of 'ExtType' objects>, '__new__': <staticmethod object at 0x7f119cad5940>, '__doc__': 'ExtType represents ext type in msgpack.'})"
...
class Unpacker(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f119caed090>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f119caf08d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas.io.msgpack._unpacker', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f119caf08d0>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/pandas/io/msgpack/_unpacker.cpython-35m-x86_64-linux-gnu.so')"
