...
class AST(object):
    ...
    _attributes = ()
    _fields = ()
    __dict__ = None # (!) real value is "mappingproxy({'_fields': (), '__reduce__': <method '__reduce__' of '_ast.AST' objects>, '__new__': <built-in method __new__ of type object at 0x9ac160>, '__init__': <slot wrapper '__init__' of '_ast.AST' objects>, '__setattr__': <slot wrapper '__setattr__' of '_ast.AST' objects>, '__delattr__': <slot wrapper '__delattr__' of '_ast.AST' objects>, '__getattribute__': <slot wrapper '__getattribute__' of '_ast.AST' objects>, '__dict__': <attribute '__dict__' of '_ast.AST' objects>, '_attributes': (), '__doc__': None})"
