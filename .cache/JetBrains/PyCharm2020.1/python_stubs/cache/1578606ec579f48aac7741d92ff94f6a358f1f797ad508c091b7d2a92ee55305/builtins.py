...
class classmethod(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__func__': <member '__func__' of 'classmethod' objects>, '__get__': <slot wrapper '__get__' of 'classmethod' objects>, '__new__': <built-in method __new__ of type object at 0xa36f20>, '__init__': <slot wrapper '__init__' of 'classmethod' objects>, '__isabstractmethod__': <attribute '__isabstractmethod__' of 'classmethod' objects>, '__dict__': <attribute '__dict__' of 'classmethod' objects>, '__doc__': 'classmethod(function) -> method\\n\\nConvert a function to be a class method.\\n\\nA class method receives the class as implicit first argument,\\njust like an instance method receives the instance.\\nTo declare a class method, use this idiom:\\n\\n  class C:\\n      def f(cls, arg1, arg2, ...): ...\\n      f = classmethod(f)\\n\\nIt can be called either on the class (e.g. C.f()) or on an instance\\n(e.g. C().f()).  The instance is ignored except for its class.\\nIf a class method is called for a derived class, the derived class\\nobject is passed as the implied first argument.\\n\\nClass methods are different than C++ or Java static methods.\\nIf you want those, see the staticmethod builtin.'})"
...
class staticmethod(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__func__': <member '__func__' of 'staticmethod' objects>, '__get__': <slot wrapper '__get__' of 'staticmethod' objects>, '__new__': <built-in method __new__ of type object at 0xa36d00>, '__init__': <slot wrapper '__init__' of 'staticmethod' objects>, '__isabstractmethod__': <attribute '__isabstractmethod__' of 'staticmethod' objects>, '__dict__': <attribute '__dict__' of 'staticmethod' objects>, '__doc__': 'staticmethod(function) -> method\\n\\nConvert a function to be a static method.\\n\\nA static method does not receive an implicit first argument.\\nTo declare a static method, use this idiom:\\n\\n     class C:\\n     def f(arg1, arg2, ...): ...\\n     f = staticmethod(f)\\n\\nIt can be called either on the class (e.g. C.f()) or on an instance\\n(e.g. C().f()).  The instance is ignored except for its class.\\n\\nStatic methods in Python are similar to those found in Java or C++.\\nFor a more advanced concept, see the classmethod builtin.'})"
...
class type(object):
    ...
    __basicsize__ = 864
    __dictoffset__ = 264
    __dict__ = None # (!) real value is "mappingproxy({'__dict__': <attribute '__dict__' of 'type' objects>, '__call__': <slot wrapper '__call__' of 'type' objects>, '__init__': <slot wrapper '__init__' of 'type' objects>, '__setattr__': <slot wrapper '__setattr__' of 'type' objects>, '__instancecheck__': <method '__instancecheck__' of 'type' objects>, '__flags__': <member '__flags__' of 'type' objects>, '__abstractmethods__': <attribute '__abstractmethods__' of 'type' objects>, '__new__': <built-in method __new__ of type object at 0xa3ede0>, '__delattr__': <slot wrapper '__delattr__' of 'type' objects>, '__module__': <attribute '__module__' of 'type' objects>, '__weakrefoffset__': <member '__weakrefoffset__' of 'type' objects>, '__prepare__': <method '__prepare__' of 'type' objects>, '__dir__': <method '__dir__' of 'type' objects>, '__text_signature__': <attribute '__text_signature__' of 'type' objects>, '__getattribute__': <slot wrapper '__getattribute__' of 'type' objects>, '__subclasscheck__': <method '__subclasscheck__' of 'type' objects>, '__sizeof__': <method '__sizeof__' of 'type' objects>, '__qualname__': <attribute '__qualname__' of 'type' objects>, 'mro': <method 'mro' of 'type' objects>, '__dictoffset__': <member '__dictoffset__' of 'type' objects>, '__bases__': <attribute '__bases__' of 'type' objects>, '__repr__': <slot wrapper '__repr__' of 'type' objects>, '__name__': <attribute '__name__' of 'type' objects>, '__mro__': <member '__mro__' of 'type' objects>, '__base__': <member '__base__' of 'type' objects>, '__subclasses__': <method '__subclasses__' of 'type' objects>, '__basicsize__': <member '__basicsize__' of 'type' objects>, '__itemsize__': <member '__itemsize__' of 'type' objects>, '__doc__': <attribute '__doc__' of 'type' objects>})"
