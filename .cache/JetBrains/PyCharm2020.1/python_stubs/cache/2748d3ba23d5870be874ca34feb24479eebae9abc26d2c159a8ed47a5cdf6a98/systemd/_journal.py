...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afaeb8>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd._journal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afaeb8>, origin='/usr/lib/python3/dist-packages/systemd/_journal.cpython-35m-x86_64-linux-gnu.so')"
