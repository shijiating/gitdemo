...
memory_debugger = None # (!) real value is '<lxml.etree._MemDebug object at 0x7fb822a86180>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afad68>'

__pyx_capi__ = {
    'appendChild': None, # (!) real value is '<capsule object "void (struct LxmlElement *, struct LxmlElement *)" at 0x7fb820af49c0>'
    'appendChildToElement': None, # (!) real value is '<capsule object "int (struct LxmlElement *, struct LxmlElement *)" at 0x7fb820af49f0>'
    'attributeValue': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, xmlAttr *)" at 0x7fb820af4720>'
    'attributeValueFromNsName': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, const xmlChar *, const xmlChar *)" at 0x7fb820af4750>'
    'callLookupFallback': None, # (!) real value is '<capsule object "PyObject *(struct LxmlFallbackElementClassLookup *, struct LxmlDocument *, xmlNode *)" at 0x7fb820af4540>'
    'collectAttributes': None, # (!) real value is '<capsule object "PyObject *(xmlNode *, int)" at 0x7fb820af47e0>'
    'deepcopyNodeToDocument': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlDocument *, xmlNode *)" at 0x7fb820af4390>'
    'delAttribute': None, # (!) real value is '<capsule object "int (struct LxmlElement *, PyObject *)" at 0x7fb820af4840>'
    'delAttributeFromNsName': None, # (!) real value is '<capsule object "int (xmlNode *, const xmlChar *, const xmlChar *)" at 0x7fb820af4870>'
    'documentOrRaise': None, # (!) real value is '<capsule object "struct LxmlDocument *(PyObject *)" at 0x7fb820af45a0>'
    'elementFactory': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlDocument *, xmlNode *)" at 0x7fb820af4420>'
    'elementTreeFactory': None, # (!) real value is '<capsule object "struct LxmlElementTree *(struct LxmlElement *)" at 0x7fb820af43c0>'
    'findChild': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7fb820af48d0>'
    'findChildBackwards': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7fb820af4930>'
    'findChildForwards': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *, Py_ssize_t)" at 0x7fb820af4900>'
    'findOrBuildNodeNsPrefix': None, # (!) real value is '<capsule object "xmlNs *(struct LxmlDocument *, xmlNode *, const xmlChar *, const xmlChar *)" at 0x7fb820af4ba0>'
    'getAttributeValue': None, # (!) real value is '<capsule object "PyObject *(struct LxmlElement *, PyObject *, PyObject *)" at 0x7fb820af4780>'
    'getNsTag': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7fb820af4a80>'
    'getNsTagWithEmptyNs': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7fb820af4ab0>'
    'hasChild': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7fb820af48a0>'
    'hasTail': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7fb820af4630>'
    'hasText': None, # (!) real value is '<capsule object "int (xmlNode *)" at 0x7fb820af4600>'
    'initTagMatch': None, # (!) real value is '<capsule object "void (struct LxmlElementTagMatcher *, PyObject *)" at 0x7fb820af4b70>'
    'iteratorStoreNext': None, # (!) real value is '<capsule object "void (struct LxmlElementIterator *, struct LxmlElement *)" at 0x7fb820af4b40>'
    'iterattributes': None, # (!) real value is '<capsule object "PyObject *(struct LxmlElement *, int)" at 0x7fb820af47b0>'
    'lookupDefaultElementClass': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, xmlNode *)" at 0x7fb820af44e0>'
    'lookupNamespaceElementClass': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, xmlNode *)" at 0x7fb820af4510>'
    'makeElement': None, # (!) real value is '<capsule object "struct LxmlElement *(PyObject *, struct LxmlDocument *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *)" at 0x7fb820af4450>'
    'makeSubElement': None, # (!) real value is '<capsule object "struct LxmlElement *(struct LxmlElement *, PyObject *, PyObject *, PyObject *, PyObject *, PyObject *)" at 0x7fb820af4480>'
    'namespacedName': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7fb820af4ae0>'
    'namespacedNameFromNsName': None, # (!) real value is '<capsule object "PyObject *(const xmlChar *, const xmlChar *)" at 0x7fb820af4b10>'
    'newElementTree': None, # (!) real value is '<capsule object "struct LxmlElementTree *(struct LxmlElement *, PyObject *)" at 0x7fb820af43f0>'
    'nextElement': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *)" at 0x7fb820af4960>'
    'previousElement': None, # (!) real value is '<capsule object "xmlNode *(xmlNode *)" at 0x7fb820af4990>'
    'pyunicode': None, # (!) real value is '<capsule object "PyObject *(const xmlChar *)" at 0x7fb820af4a20>'
    'rootNodeOrRaise': None, # (!) real value is '<capsule object "struct LxmlElement *(PyObject *)" at 0x7fb820af45d0>'
    'setAttributeValue': None, # (!) real value is '<capsule object "int (struct LxmlElement *, PyObject *, PyObject *)" at 0x7fb820af4810>'
    'setElementClassLookupFunction': None, # (!) real value is '<capsule object "void (_element_class_lookup_function, PyObject *)" at 0x7fb820af44b0>'
    'setNodeText': None, # (!) real value is '<capsule object "int (xmlNode *, PyObject *)" at 0x7fb820af46c0>'
    'setTailText': None, # (!) real value is '<capsule object "int (xmlNode *, PyObject *)" at 0x7fb820af46f0>'
    'tagMatches': None, # (!) real value is '<capsule object "int (xmlNode *, const xmlChar *, const xmlChar *)" at 0x7fb820af4570>'
    'tailOf': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7fb820af4690>'
    'textOf': None, # (!) real value is '<capsule object "PyObject *(xmlNode *)" at 0x7fb820af4660>'
    'utf8': None, # (!) real value is '<capsule object "PyObject *(PyObject *)" at 0x7fb820af4a50>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.etree', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afad68>, origin='/usr/lib/python3/dist-packages/lxml/etree.cpython-35m-x86_64-linux-gnu.so')"
