...
class BinaryIO(__typing.IO):
    ...
    _abc_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000be080>'
    _abc_negative_cache_version = 46
...
class TextIO(__typing.IO):
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000be358>'
    _abc_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000be3c8>'
    _abc_negative_cache_version = 46
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000be2e8>'
