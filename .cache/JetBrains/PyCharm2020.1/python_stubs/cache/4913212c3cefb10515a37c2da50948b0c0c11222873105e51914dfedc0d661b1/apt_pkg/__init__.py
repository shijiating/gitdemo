...
config = None # (!) real value is '<apt_pkg.Configuration object at 0x7fb820ba7850>'
...
_C_API = None # (!) real value is '<capsule object "apt_pkg._C_API" at 0x7fb820bf3e70>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afa828>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_pkg', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afa828>, origin='/usr/lib/python3/dist-packages/apt_pkg.cpython-35m-x86_64-linux-gnu.so')"
