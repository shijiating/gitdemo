...
class IO(__typing.Generic):
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f260072c9e8>'
    _abc_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f260072ca58>'
    _abc_negative_cache_version = 46
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f260072c9b0>'
...
class BinaryIO(__typing.IO):
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f260072cd30>'
    _abc_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f260072cda0>'
    _abc_negative_cache_version = 46
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f260072ccf8>'
