...
class TextIO(__typing.IO):
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000c02e8>'
    _abc_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000c0358>'
    _abc_negative_cache_version = 46
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7f26000c0278>'
