...
_API = None # (!) real value is '<capsule object "gi._API" at 0x7fb820af4180>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820b14ef0>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820b14ef0>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-35m-x86_64-linux-gnu.so')"
