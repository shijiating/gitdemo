...
# from /usr/lib/python3/dist-packages/cryptography/hazmat/bindings/_openssl.cpython-35m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
def X509_up_ref(*args, **kwargs): # real signature unknown
    """ direct call to the C function of the same name """
    pass
