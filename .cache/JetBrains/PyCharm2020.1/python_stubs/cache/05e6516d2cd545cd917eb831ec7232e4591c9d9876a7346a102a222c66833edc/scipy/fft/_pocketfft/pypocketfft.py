...
def dct(a, type, axes=None, inorm=0, out=None, nthreads=1): # real signature unknown; restored from __doc__
    """
...
def dst(a, type, axes=None, inorm=0, out=None, nthreads=1): # real signature unknown; restored from __doc__
    """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006f0630>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.fft._pocketfft.pypocketfft', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006f0630>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/scipy/fft/_pocketfft/pypocketfft.cpython-35m-x86_64-linux-gnu.so')"
