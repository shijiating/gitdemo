...
class SFC64(__numpy_random__bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f11ac224750>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f11a51ecb00>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._sfc64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f11a51ecb00>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/numpy/random/_sfc64.cpython-35m-x86_64-linux-gnu.so')"
