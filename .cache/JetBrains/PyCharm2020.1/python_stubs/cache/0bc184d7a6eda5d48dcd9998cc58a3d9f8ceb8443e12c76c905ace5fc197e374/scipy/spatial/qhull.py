...
class _QhullUser(object):
    ...
    _qhull = None
    __dict__ = None # (!) real value is "mappingproxy({'__dict__': <attribute '__dict__' of '_QhullUser' objects>, '__init__': <cyfunction _QhullUser.__init__ at 0x7f26006be048>, '_add_points': <cyfunction _QhullUser._add_points at 0x7f26006be328>, 'close': <cyfunction _QhullUser.close at 0x7f26006be100>, '_qhull': None, '__module__': 'scipy.spatial.qhull', '__doc__': '\\n    Takes care of basic dealings with the Qhull objects\\n    ', '__weakref__': <attribute '__weakref__' of '_QhullUser' objects>, '__del__': <cyfunction _QhullUser.__del__ at 0x7f26006be1b8>, '_update': <cyfunction _QhullUser._update at 0x7f26006be270>})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006b3320>'

__pyx_capi__ = {
    '_barycentric_coordinate_single': None, # (!) real value is '<capsule object "void (int, double *, double *, double *, int)" at 0x7f26006a4a20>'
    '_barycentric_coordinates': None, # (!) real value is '<capsule object "void (int, double *, double *, double *)" at 0x7f26006a4a50>'
    '_barycentric_inside': None, # (!) real value is '<capsule object "int (int, double *, double *, double *, double)" at 0x7f26006a49f0>'
    '_distplane': None, # (!) real value is '<capsule object "double (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, int, double *)" at 0x7f26006a4ab0>'
    '_find_simplex': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *, int *, double, double)" at 0x7f26006a4b70>'
    '_find_simplex_bruteforce': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *, double, double)" at 0x7f26006a4b10>'
    '_find_simplex_directed': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *, int *, double, double)" at 0x7f26006a4b40>'
    '_get_delaunay_info': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, PyObject *, int, int, int)" at 0x7f26006a49c0>'
    '_is_point_fully_outside': None, # (!) real value is '<capsule object "int (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double)" at 0x7f26006a4ae0>'
    '_lift_point': None, # (!) real value is '<capsule object "void (__pyx_t_5scipy_7spatial_5qhull_DelaunayInfo_t *, double *, double *)" at 0x7f26006a4a80>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.spatial.qhull', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26006b3320>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/scipy/spatial/qhull.cpython-35m-x86_64-linux-gnu.so')"
