...
def ellipk(x, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def voigt_profile(x1, x2, x3, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def _riemann_zeta(x, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
class errstate(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__dict__\': <attribute \'__dict__\' of \'errstate\' objects>, \'__init__\': <cyfunction errstate.__init__ at 0x7f2600713b10>, \'__weakref__\': <attribute \'__weakref__\' of \'errstate\' objects>, \'__enter__\': <cyfunction errstate.__enter__ at 0x7f2600713bc8>, \'__module__\': \'scipy.special._ufuncs\', \'__exit__\': <cyfunction errstate.__exit__ at 0x7f2600713c80>, \'__doc__\': "Context manager for special-function error handling.\\n\\n    Using an instance of `errstate` as a context manager allows\\n    statements in that context to execute with a known error handling\\n    behavior. Upon entering the context the error handling is set with\\n    `seterr`, and upon exiting it is restored to what it was before.\\n\\n    Parameters\\n    ----------\\n    kwargs : {all, singular, underflow, overflow, slow, loss, no_result, domain, arg, other}\\n        Keyword arguments. The valid keywords are possible\\n        special-function errors. Each keyword should have a string\\n        value that defines the treatement for the particular type of\\n        error. Values must be \'ignore\', \'warn\', or \'other\'. See\\n        `seterr` for details.\\n\\n    See Also\\n    --------\\n    geterr : get the current way of handling special-function errors\\n    seterr : set how special-function errors are handled\\n    numpy.errstate : similar numpy function for floating-point errors\\n\\n    Examples\\n    --------\\n    >>> import scipy.special as sc\\n    >>> from pytest import raises\\n    >>> sc.gammaln(0)\\n    inf\\n    >>> with sc.errstate(singular=\'raise\'):\\n    ...     with raises(sc.SpecialFunctionError):\\n    ...         sc.gammaln(0)\\n    ...\\n    >>> sc.gammaln(0)\\n    inf\\n\\n    We can also raise on every category except one.\\n\\n    >>> with sc.errstate(all=\'raise\', singular=\'ignore\'):\\n    ...     sc.gammaln(0)\\n    ...     with raises(sc.SpecialFunctionError):\\n    ...         sc.spence(-1)\\n    ...\\n    inf\\n\\n    "})'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26007022b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='scipy.special._ufuncs', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f26007022b0>, origin='/home/sjt/chinafyl-adminycj-master/venv/ycj35/lib/python3.5/site-packages/scipy/special/_ufuncs.cpython-35m-x86_64-linux-gnu.so')"
