...
# from /usr/lib/python3/dist-packages/_cffi_backend.cpython-35m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
_C_API = None # (!) real value is '<capsule object "cffi" at 0x7fb820bf37e0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb81f98a898>'

__spec__ = None # (!) real value is "ModuleSpec(name='_cffi_backend', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb81f98a898>, origin='/usr/lib/python3/dist-packages/_cffi_backend.cpython-35m-x86_64-linux-gnu.so')"
