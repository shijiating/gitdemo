...
class _IOBase(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'_checkClosed\': <method \'_checkClosed\' of \'_io._IOBase\' objects>, \'__dict__\': <attribute \'__dict__\' of \'_io._IOBase\' objects>, \'__new__\': <built-in method __new__ of type object at 0x9b3360>, \'seekable\': <method \'seekable\' of \'_io._IOBase\' objects>, \'__iter__\': <slot wrapper \'__iter__\' of \'_io._IOBase\' objects>, \'writelines\': <method \'writelines\' of \'_io._IOBase\' objects>, \'tell\': <method \'tell\' of \'_io._IOBase\' objects>, \'__doc__\': "The abstract base class for all I/O classes, acting on streams of\\nbytes. There is no public constructor.\\n\\nThis class provides dummy implementations for many methods that\\nderived classes can override selectively; the default implementations\\nrepresent a file that cannot be read, written or seeked.\\n\\nEven though IOBase does not declare read, readinto, or write because\\ntheir signatures will vary, implementations and clients should\\nconsider those methods part of the interface. Also, implementations\\nmay raise UnsupportedOperation when operations they do not support are\\ncalled.\\n\\nThe basic type used for binary data read from or written to a file is\\nbytes. Other bytes-like objects are accepted as method arguments too.\\nIn some cases (such as readinto), a writable object is required. Text\\nI/O classes work with str data.\\n\\nNote that calling any method (except additional calls to close(),\\nwhich are ignored) on a closed stream should raise a ValueError.\\n\\nIOBase (and its subclasses) support the iterator protocol, meaning\\nthat an IOBase object can be iterated over yielding the lines in a\\nstream.\\n\\nIOBase also supports the :keyword:`with` statement. In this example,\\nfp is closed after the suite of the with statement is complete:\\n\\nwith open(\'spam.txt\', \'r\') as fp:\\n    fp.write(\'Spam and eggs!\')\\n", \'writable\': <method \'writable\' of \'_io._IOBase\' objects>, \'close\': <method \'close\' of \'_io._IOBase\' objects>, \'_checkWritable\': <method \'_checkWritable\' of \'_io._IOBase\' objects>, \'_checkReadable\': <method \'_checkReadable\' of \'_io._IOBase\' objects>, \'closed\': <attribute \'closed\' of \'_io._IOBase\' objects>, \'readlines\': <method \'readlines\' of \'_io._IOBase\' objects>, \'readline\': <method \'readline\' of \'_io._IOBase\' objects>, \'__exit__\': <method \'__exit__\' of \'_io._IOBase\' objects>, \'flush\': <method \'flush\' of \'_io._IOBase\' objects>, \'truncate\': <method \'truncate\' of \'_io._IOBase\' objects>, \'readable\': <method \'readable\' of \'_io._IOBase\' objects>, \'__next__\': <slot wrapper \'__next__\' of \'_io._IOBase\' objects>, \'isatty\': <method \'isatty\' of \'_io._IOBase\' objects>, \'__del__\': <slot wrapper \'__del__\' of \'_io._IOBase\' objects>, \'fileno\': <method \'fileno\' of \'_io._IOBase\' objects>, \'_checkSeekable\': <method \'_checkSeekable\' of \'_io._IOBase\' objects>, \'__enter__\': <method \'__enter__\' of \'_io._IOBase\' objects>, \'seek\': <method \'seek\' of \'_io._IOBase\' objects>})'
