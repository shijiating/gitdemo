...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb255264a20>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb255264a20>, origin='/usr/lib/python3.5/lib-dynload/_json.cpython-35m-x86_64-linux-gnu.so')"
