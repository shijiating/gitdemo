...
class ObjectifiedElement(__lxml_etree.ElementBase):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__reduce__\': <method \'__reduce__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__getattr__\': <method \'__getattr__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__iter__\': <slot wrapper \'__iter__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__delitem__\': <slot wrapper \'__delitem__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__dict__\': <attribute \'__dict__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__getitem__\': <slot wrapper \'__getitem__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'addattr\': <method \'addattr\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__getattribute__\': <slot wrapper \'__getattribute__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'text\': <attribute \'text\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__str__\': <slot wrapper \'__str__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__doc__\': \'Main XML Element class.\\n\\n    Element children are accessed as object attributes.  Multiple children\\n    with the same name are available through a list index.  Example::\\n\\n       >>> root = XML("<root><c1><c2>0</c2><c2>1</c2></c1></root>")\\n       >>> second_c2 = root.c1.c2[1]\\n       >>> print(second_c2.text)\\n       1\\n\\n    Note that you cannot (and must not) instantiate this class or its\\n    subclasses.\\n    \', \'countchildren\': <method \'countchildren\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__setattr__\': <slot wrapper \'__setattr__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__len__\': <slot wrapper \'__len__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__delattr__\': <slot wrapper \'__delattr__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'getchildren\': <method \'getchildren\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'__new__\': <built-in method __new__ of type object at 0x7fb81f46e900>, \'__setitem__\': <slot wrapper \'__setitem__\' of \'lxml.objectify.ObjectifiedElement\' objects>, \'descendantpaths\': <method \'descendantpaths\' of \'lxml.objectify.ObjectifiedElement\' objects>})'
...
class ElementMaker(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fb820bf37e0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afad30>'

__spec__ = None # (!) real value is "ModuleSpec(name='lxml.objectify', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb820afad30>, origin='/usr/lib/python3/dist-packages/lxml/objectify.cpython-35m-x86_64-linux-gnu.so')"
