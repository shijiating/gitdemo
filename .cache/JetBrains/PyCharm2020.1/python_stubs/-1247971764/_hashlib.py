...
openssl_md_meth_names = None # (!) real value is "frozenset({'SHA384', 'SHA', 'dsaEncryption', 'ecdsa-with-SHA1', 'DSA', 'md5', 'sha224', 'SHA224', 'sha384', 'dsaWithSHA', 'sha512', 'DSA-SHA', 'sha1', 'MD5', 'sha', 'MD4', 'SHA1', 'SHA256', 'whirlpool', 'sha256', 'SHA512', 'md4', 'RIPEMD160', 'ripemd160'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb254ee85f8>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fb254ee85f8>, origin='/usr/lib/python3.5/lib-dynload/_hashlib.cpython-35m-x86_64-linux-gnu.so')"
